...
Функция ИмяТаблицыПослеРазворачивания() Экспорт
	
	Возврат "ITKИмяТаблицыПослеРазворачивания";
...
Функция Заголовок() Экспорт
	...
	Возврат НСтр("ru = 'Конструктор запроса';
...
Функция ИдентификаторКолонкиТипПоля() Экспорт
	
	Возврат ИТК_ТуллкитКлиентСервер.Префикс() + "Картинка";
	
КонецФункции

Функция ИдентификаторКолонкиТипЗначенияПоля() Экспорт
	
	Возврат ИТК_ТуллкитКлиентСервер.Префикс() + "ТипЗначения";
	
КонецФункции

Функция ПрефиксУстановитьПолеОбъединения() Экспорт
	
	Возврат "ITK_УстановитьПолеОбъединения:";
