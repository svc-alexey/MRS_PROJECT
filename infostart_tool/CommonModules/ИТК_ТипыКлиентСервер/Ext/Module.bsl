...
Функция ОписаниеИмяМетаданных() Экспорт
	...
	Возврат ОписаниеСтрока(ИТК_МетаданныеКлиентСерверПовтИсп.МаксимальнаяДлинаИмени());
	
КонецФункции

Функция ОписаниеКоллекцияИИмяМетаданных() Экспорт
	
	Возврат ОписаниеСтрока();
	
КонецФункции

Функция ОписаниеСинонимМетаданных() Экспорт
	
	Возврат ОписаниеСтрока(ИТК_МетаданныеКлиентСерверПовтИсп.МаксимальнаяДлинаСинонима());
	
КонецФункции

Функция ОписаниеПодсказкаМетаданных() Экспорт
	
	Возврат ОписаниеСтрока(ИТК_МетаданныеКлиентСерверПовтИсп.МаксимальнаяДлинаПодсказки());
...
Функция ЭтоСсылочный(Тип, ИсключаяПеречисления = Ложь) Экспорт
	...
	Результат = ОписаниеТиповЛюбаяСсылка().СодержитТип(Тип);
	Если ИсключаяПеречисления Тогда 
		
		#Если Сервер Тогда
			
			Если ИТК_Метаданные.ТипВсеСсылкиКоллекции("Перечисления").СодержитТип(Тип) Тогда
				Результат = Ложь;  
			КонецЕсли;
...
Функция ОписаниеИзСтроки(Тип) Экспорт
	...
	Иначе
		...
		Имя = СокрЛП(ИТК_Строки.РазборПрочитатьИдентификатор(Тип));
		Параметр = ИТК_Строки.РазборПрочитатьЦелоеЧисло(Тип, СимволСкобки + 1);
...
Функция ОписаниеТиповЛюбаяСсылка() Экспорт
	Возврат ИТК_ТипыКлиентСерверПовтИсп.ОписаниеТиповЛюбаяСсылка();
КонецФункции
