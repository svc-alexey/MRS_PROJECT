...
// Возвращает описание таблицы МВТ
//
// Параметры:
//  Данные - Данные - Данные
...
//
// Возвращаемое значение:
//   Структура - Описание таблицы МВТ
//
Функция ТаблицаМВТ(Данные, UID) Экспорт
	
	Возврат Данные.ТаблицыМВТ.Получить(UID);
	
КонецФункции

Процедура ВставитьТаблицуМВТ(Форма, Строка, UID, Описание) Экспорт
	
	Данные = ИТК_КонсольРазработчикаДанныеКлиентСервер.Получить(Строка);
	Форма.Модифицированность = Истина;
	
	Данные.ТаблицыМВТ.Вставить(UID, Описание);
	
КонецПроцедуры

Процедура УдалитьТаблицуМВТ(Форма, Строка, UID) Экспорт
	
	Данные = ИТК_КонсольРазработчикаДанныеКлиентСервер.Получить(Строка);
	Форма.Модифицированность = Истина;
	
	Данные.ТаблицыМВТ.Удалить(UID);
	
КонецПроцедуры

Процедура СкопироватьТаблицуМВТ(Форма, Строка, Имя, UID, UIDИсточника) Экспорт
	
	Данные = ИТК_КонсольРазработчикаДанныеКлиентСервер.Получить(Строка);
	ОписаниеИсточника = ИТК_КонсольРазработчикаДанныеКлиент.ТаблицаМВТ(Данные, UIDИсточника);
	Тип = ОписаниеИсточника.Тип;
	
	Описание = ИТК_КонсольРазработчикаДанныеКлиентСервер.НоваяТаблицаМВТ();
	Описание.Имя = Имя;
	Описание.Тип = Тип;
	...
	ВставитьТаблицуМВТ(Форма, Строка, UID, Описание);
