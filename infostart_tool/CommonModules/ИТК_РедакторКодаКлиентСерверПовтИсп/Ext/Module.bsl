...
Функция СоответствиеИменКоллекцийИТипов() Экспорт 
	...
	Результат.Вставить("внешниеисточникиданных", "externalDataSources");
	Результат.Вставить("ОбщиеМодули", "commonModules");
	Результат.Вставить("xdtopackages", "XDTOPackages");
	Результат.Вставить("xdtoпакеты", "XDTOPackages");
...
Функция СоответствиеИменКоллекцийИИмениКаталогаВыгрузки() Экспорт 
	...
	Результат.Вставить("constants"                   , "Constants");
	Результат.Вставить("общиемодули"                 , "CommonModules");
	Результат.Вставить("общиекоманды"                , "CommonCommands");
