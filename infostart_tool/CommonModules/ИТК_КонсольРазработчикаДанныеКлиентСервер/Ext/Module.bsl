...
Функция НовыйЭлемент(ТипСтроки, Сохранение = Ложь) Экспорт
	...
	Если ЭтоТипСтрокиСИспользованиемМВТ(ТипСтроки) Тогда
		
		Результат.Вставить("ТаблицыМВТ", Новый Соответствие);
		
		Если Не Сохранение Тогда
			Результат.Вставить("ОписаниеТаблицМВТ", Новый Соответствие);
		КонецЕсли;
...
Функция ЭтоТипСтрокиСИспользованиемМВТ(Тип) Экспорт
...
Функция НоваяТаблицаМВТ(Имя = Неопределено, Тип = Неопределено, Значение = Неопределено) Экспорт
...
// Возвращает таблицы МВТ
//
// Параметры:
//  Данные - Данные - Данные
//
// Возвращаемое значение:
//   Соответствие - Данные твблиц МВТ
//
Функция ТаблицыМВТ(Данные) Экспорт
	
	Если Данные = Неопределено Тогда
		Возврат Новый Массив;
	КонецЕсли;
	
	Возврат Данные.ТаблицыМВТ;
