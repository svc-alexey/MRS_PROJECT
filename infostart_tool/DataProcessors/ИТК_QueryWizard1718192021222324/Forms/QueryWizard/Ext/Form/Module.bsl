	...
	For GroupPos = 0 To GroupCount-1 Do
		...
		If AllowGrouping Then
			...
			NewItem["Presentation"] = StrTemplate(
				NStr("ru = 'Группировка %1';
					|SYS = 'QueryEditor.GroupingSetNumber'", "ru"),
				GroupPos + 1);
...
Procedure ShowQueryEditor(Val QueryText, OldQueryText = "", Val StartRow = -1, Val StartCol = -1)
	...
	Form = OpenForm("DataProcessor.ИТК_QueryWizard1718192021222324.Form.QueryEditor", Params, ThisForm,,,,Notification,
...
Procedure GroupingFieldsDrag(Item, DragParameters, StandardProcessing, Row, Field)
	...
	if Items.GroupingFields.CurrentRow <> Undefined Then
		// ITK39 * {
		//GroupingSet = Items.GroupingFields.FindByID(Items.GroupingFields.CurrentRow)["GroupingSet"];
		GroupingSet = GroupingFields.FindByID(Items.GroupingFields.CurrentRow)["GroupingSet"];
		// }
    EndIf;
...
Procedure ExpressionChange(Val IsExpression, Val NewExpression = Undefined, Val IsExpressionChanged = Undefined)
    ...
    OpenForm("DataProcessor.ИТК_QueryWizard1718192021222324.Form.ArbitraryExpression", Params, ThisForm,,,,Notification,
             FormWindowOpeningMode.LockOwnerWindow);
EndProcedure
...
Procedure SourcesParametersOfTheVirtualTable(Command)
	...
	OpenForm("DataProcessor.ИТК_QueryWizard1718192021222324.Form.AvailableTableParameters", Params, ThisForm,,,,Notification,
             FormWindowOpeningMode.LockOwnerWindow);
EndProcedure
...
Procedure SourcesCreateDescriptionOfTheTemporaryTable(Command)
	...
	Params.Insert("NestedQueryPositionAddress", NestedQueryPositionAddress);
	Notification = New NotifyDescription("TableParametersChanged", ThisForm, Params);
	OpenForm("DataProcessor.ИТК_QueryWizard1718192021222324.Form.TempTable", Params, ThisForm,,,,Notification,
             FormWindowOpeningMode.LockOwnerWindow);
EndProcedure
...
Procedure EditNestedQuery(Val NotificationName, Val NestedQuerySourceIndex, Val IsNew, Val QueryText = Undefined)
	...
	OpenForm("DataProcessor.ИТК_QueryWizard1718192021222324.Form.QueryWizard", Params,, True,,,
...
Procedure SourcesReplaceTheTable(Command)
	...
	OpenForm("DataProcessor.ИТК_QueryWizard1718192021222324.Form.TableSelecting", Params, ThisForm,,,,Notification,
             FormWindowOpeningMode.LockOwnerWindow);
EndProcedure
...
Procedure DataCompositionRequiredJoinsParametersOfTheVirtualTable(Command)
	...
	OpenForm("DataProcessor.ИТК_QueryWizard1718192021222324.Form.DataCompositionAvailableTableParameters", Params, ThisForm,,,,Notification,
             FormWindowOpeningMode.LockOwnerWindow);
EndProcedure
