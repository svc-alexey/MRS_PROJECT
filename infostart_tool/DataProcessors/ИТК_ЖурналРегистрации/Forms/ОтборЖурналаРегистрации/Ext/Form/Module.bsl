...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.РазделениеДанныхСеанса.Видимость = Не ИТК_БСППовтИсп.ДоступноИспользованиеРазделенныхДанных();
...
Процедура ПриОткрытии(Отказ)
	...
	ИТК_ФормаКлиент.АктивизацияЗначенияВФорме(Элементы.Данные, Данные);
...
Процедура ИсполнениеВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	ИначеЕсли РедакторСоставаСвойстваИмяЭлемента = Элементы.РазделениеДанныхСеанса.Имя Тогда
		...
		ОткрытьФорму("Обработка.ИТК_ЖурналРегистрации.Форма.РазделениеДанныхСеанса", ПараметрыФормы, ЭтотОбъект);
		Возврат;
	Иначе
	...
	ОткрытьФорму("Обработка.ИТК_ЖурналРегистрации.Форма.РедакторСоставаСвойства",
	             ПараметрыФормы,
	             ЭтотОбъект);
...
&НаКлиенте
Процедура ДанныеОбработкаВыбора(Элемент, ВыбранноеЗначение, СтандартнаяОбработка)
	...
	ИТК_ФормаКлиент.АктивизацияЗначенияВФорме(Элементы.Данные, ВыбранноеЗначение, Новый ОписаниеТипов);
	
КонецПроцедуры

&НаКлиенте
Процедура ДанныеОчистка(Элемент, СтандартнаяОбработка)
	
	Данные = ИТК_ФормаКлиент.ОчисткаВыбранногоОбъекта(ЭтотОбъект, "Данные", СтандартнаяОбработка);
	ИТК_ФормаКлиент.АктивизацияЗначенияВФорме(Элементы.Данные, Данные);

КонецПроцедуры

&НаКлиенте
Процедура ДанныеНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	
	ЗаголовокВыбора = НСтр("ru = 'Данные';
							|en = 'Data'");
	ИТК_ФормаКлиент.НачалоВыбораЗначенияВФорме(ЭтотОбъект, "Данные", ЗаголовокВыбора, СтандартнаяОбработка);
...
&НаКлиенте
Процедура ДанныеАвтоПодбор(Элемент, Текст, ДанныеВыбора, ПараметрыПолученияДанных, Ожидание, СтандартнаяОбработка)
