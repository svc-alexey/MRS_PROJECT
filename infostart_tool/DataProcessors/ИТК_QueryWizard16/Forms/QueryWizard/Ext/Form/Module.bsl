...
Procedure ShowQueryEditor(Val QueryText, OldQueryText = "", Val StartRow = -1, Val StartCol = -1)
	...
	Form = OpenForm("DataProcessor.ИТК_QueryWizard16.Form.QueryEditor", Params, ThisForm,,,,Notification,
...
Procedure ExpressionChange(Val IsExpression, Val NewExpression = Undefined, Val IsExpressionChanged = Undefined)
    ...
    OpenForm("DataProcessor.ИТК_QueryWizard16.Form.ArbitraryExpression", Params, ThisForm,,,,Notification,
             FormWindowOpeningMode.LockOwnerWindow);
EndProcedure
...
Procedure SourcesParametersOfTheVirtualTable(Command)
	...
	OpenForm("DataProcessor.ИТК_QueryWizard16.Form.AvailableTableParameters", Params, ThisForm,,,,Notification,
             FormWindowOpeningMode.LockOwnerWindow);
EndProcedure
...
Procedure SourcesCreateDescriptionOfTheTemporaryTable(Command)
	...
	Params.Insert("NestedQueryPositionAddress", NestedQueryPositionAddress);
	Notification = New NotifyDescription("TableParametersChanged", ThisForm, Params);
	OpenForm("DataProcessor.ИТК_QueryWizard16.Form.TempTable", Params, ThisForm,,,,Notification,
             FormWindowOpeningMode.LockOwnerWindow);
EndProcedure
...
Procedure EditNestedQuery(Val NotificationName, Val NestedQuerySourceIndex, Val IsNew, Val QueryText = Undefined)
	...
	OpenForm("DataProcessor.ИТК_QueryWizard16.Form.QueryWizard", Params,, True,,,
...
Procedure SourcesReplaceTheTable(Command)
	...
	OpenForm("DataProcessor.ИТК_QueryWizard16.Form.TableSelecting", Params, ThisForm,,,,Notification,
             FormWindowOpeningMode.LockOwnerWindow);
EndProcedure
...
Procedure DataCompositionRequiredJoinsParametersOfTheVirtualTable(Command)
	...
	OpenForm("DataProcessor.ИТК_QueryWizard16.Form.DataCompositionAvailableTableParameters", Params, ThisForm,,,,Notification,
             FormWindowOpeningMode.LockOwnerWindow);
EndProcedure
